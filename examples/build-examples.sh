#!/bin/bash
set -e
cp "../eisvogel-physics.tex" "../eisvogel-physics.latex"
...
echo "- basic-example"
pandoc "basic-example/basic-example.md" -o "basic-example/basic-example.pdf" --from markdown --template "../eisvogel-physics.latex" --listings
pdftoppm -r 150 -png "basic-example/basic-example.pdf" > "basic-example/basic-example.png"

echo "- beamer"
pandoc "beamer/beamer.md" -o "beamer/beamer.pdf" --from markdown --to beamer --template "../eisvogel-physics.latex" --listings
pdftoppm -r 150 -png "beamer/beamer.pdf" > "beamer/beamer.png"

echo "- custom-titlepage"
cd "custom-titlepage"
pandoc "custom-titlepage.md" -o "custom-titlepage.pdf" --from markdown --template "../../eisvogel-physics.latex" --listings
pdftoppm -r 150 -png "custom-titlepage.pdf" > "custom-titlepage.png"
cd ".."

echo "- default-titlepage"
pandoc "default-titlepage/default-titlepage.md" -o "default-titlepage/default-titlepage.pdf" --from markdown --template "../eisvogel-physics.latex" --listings
...
echo "- listings"
pandoc "listings/listings.md" -o "listings/listings.pdf" --from markdown --template "../eisvogel-physics.latex" --listings
pdftoppm -r 150 -png "listings/listings.pdf" > "listings/listings.png"

echo "- without-listings"
pandoc "without-listings/without-listings.md" -o "without-listings/without-listings.pdf" --from markdown --template "../eisvogel-physics.latex" --highlight-style kate
pdftoppm -r 150 -png "without-listings/without-listings.pdf" > "without-listings/without-listings.png"

echo "- green-titlepage"
pandoc "green-titlepage/green-titlepage.md" -o "green-titlepage/green-titlepage.pdf" --from markdown --template "../eisvogel-physics.latex" --listings
...
cd "logo-titlepage"
pandoc "logo-titlepage.md" -o "logo-titlepage.pdf" --from markdown --template "../../eisvogel-physics.latex" --listings
pdftoppm -r 150 -png "logo-titlepage.pdf" > "logo-titlepage.png"
cd ".."

rm "../eisvogel-physics.latex"
